...
const env = {
  ...
  metaWhatsapp: {
    ...
    openingTemplateName: process.env.META_WHATSAPP_OPENING_TEMPLATE_NAME || null,
    openingTemplateLanguage: process.env.META_WHATSAPP_OPENING_TEMPLATE_LANGUAGE || 'en_US',
    openingTemplateIncludeLeadName: process.env.META_WHATSAPP_OPENING_TEMPLATE_INCLUDE_LEAD_NAME === 'true',
